...
function SideMenu() {
    const [isOpenNikeModal, setIsOpenNikeModal] = useState(false);

    return (
        <>
            <nav className="flex fixed z-[100] flex-col items-center p-2 w-1/12">
                <ul className="flex flex-col items-center mt-5 w-full">
                    <li key={0} className="m-auto cursor-pointer" onClick={() => setIsOpenNikeModal(true)}>
                        <svg className="fill-gray-100 hover:fill-gray-400" viewBox="0 0 2392 848" width="52" height="52">
                    ...
                    <li key={1} className="m-auto cursor-pointer">
                        <svg className="fill-gray-100 hover:fill-gray-400" viewBox="0 0 432 91" width="72" height="72">
            ...
            {isOpenNikeModal && <NikeModal closeModal={() => setIsOpenNikeModal(false)} />}
        </>
    )
}
